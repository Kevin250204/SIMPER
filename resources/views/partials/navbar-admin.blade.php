...
<div class="top-navbar">
    ...
    <div class="navbar-left">
        ...
        } elseif (request()->is('admin/jenis-koleksi*')) {

        $title = 'Manajemen Jenis Koleksi';
        $subtitle = 'Kelola seluruh jenis koleksi perpustakaan';

        } elseif (request()->is('admin/kategori-koleksi*')) {

        $title = 'Manajemen Kategori Koleksi';
        $subtitle = 'Kelola kategori koleksi berdasarkan jenis koleksi';
        ...
        $subtitle = 'Kelola dan cetak laporan perpustakaan';
